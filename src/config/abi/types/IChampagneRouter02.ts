...
export interface IChampagneRouter02Interface extends utils.Interface {
  functions: {
...
export interface IChampagneRouter02 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IChampagneRouter02Interface;
