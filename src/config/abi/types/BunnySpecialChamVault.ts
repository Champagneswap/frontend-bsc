...
export interface BunnySpecialChamVaultInterface extends utils.Interface {
  functions: {
    "bunnyId()": FunctionFragment;
    "bunnyMintingStation()": FunctionFragment;
    "chamVault()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "chamVault", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "chamVault", data: BytesLike): Result;
...
export interface BunnySpecialChamVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BunnySpecialChamVaultInterface;
  ...
  functions: {
    ...
    chamVault(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    chamVault(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    chamVault(overrides?: CallOverrides): Promise<PopulatedTransaction>;
