...
export class TradingCompetition__factory {
  static readonly abi = _abi;
  static createInterface(): TradingCompetitionInterface {
    return new utils.Interface(_abi) as TradingCompetitionInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TradingCompetition {
    return new Contract(address, _abi, signerOrProvider) as TradingCompetition;
  }
}
