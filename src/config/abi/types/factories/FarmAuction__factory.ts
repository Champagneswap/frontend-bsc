...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "enum FarmAuction.Status",
        name: "status",
        type: "uint8",
      },
      {
...
export class FarmAuction__factory {
  ...
  static createInterface(): FarmAuctionInterface {
    return new utils.Interface(_abi) as FarmAuctionInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): FarmAuction {
    return new Contract(address, _abi, signerOrProvider) as FarmAuction;
  }
}
