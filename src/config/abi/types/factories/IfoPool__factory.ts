...
import type { IfoPool, IfoPoolInterface } from "../IfoPool";
...
export class IfoPool__factory {
  static readonly abi = _abi;
  static createInterface(): IfoPoolInterface {
    return new utils.Interface(_abi) as IfoPoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IfoPool {
    return new Contract(address, _abi, signerOrProvider) as IfoPool;
  }
}
