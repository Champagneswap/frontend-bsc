...
import type { SousChefV3, SousChefV3Interface } from "../SousChefV3";
...
export class SousChefV3__factory {
  static readonly abi = _abi;
  static createInterface(): SousChefV3Interface {
    return new utils.Interface(_abi) as SousChefV3Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SousChefV3 {
    return new Contract(address, _abi, signerOrProvider) as SousChefV3;
  }
}
