...
import type {
  ...
  TradingCompetitionV2Interface,
} from "../TradingCompetitionV2";
...
export class TradingCompetitionV2__factory {
  static readonly abi = _abi;
  static createInterface(): TradingCompetitionV2Interface {
    return new utils.Interface(_abi) as TradingCompetitionV2Interface;
  }
  static connect(
    address: string,
