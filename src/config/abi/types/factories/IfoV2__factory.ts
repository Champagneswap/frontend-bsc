...
import type { IfoV2, IfoV2Interface } from "../IfoV2";
...
export class IfoV2__factory {
  static readonly abi = _abi;
  static createInterface(): IfoV2Interface {
    return new utils.Interface(_abi) as IfoV2Interface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): IfoV2 {
    return new Contract(address, _abi, signerOrProvider) as IfoV2;
  }
}
