...
import type {
  ...
  BunnySpecialChamVaultInterface,
} from "../BunnySpecialChamVault";
...
const _abi = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: "contract ChamVault",
        name: "",
        type: "address",
      },
    ],
...
export class BunnySpecialChamVault__factory {
  static readonly abi = _abi;
  static createInterface(): BunnySpecialChamVaultInterface {
    return new utils.Interface(_abi) as BunnySpecialChamVaultInterface;
  }
  static connect(
    address: string,
