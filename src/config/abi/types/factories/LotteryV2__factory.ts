...
const _abi = [
  ...
  },
  {
    inputs: [
      {
        internalType: "uint256",
        name: "_minPriceTicketInCham",
        type: "uint256",
      },
      {
        internalType: "uint256",
        name: "_maxPriceTicketInCham",
        type: "uint256",
      },
    ],
    name: "setMinAndMaxTicketPriceInCham",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
    ...
    outputs: [
      {
        components: [
          {
            internalType: "enum ChampagneSwapLottery.Status",
            name: "status",
            type: "uint8",
          },
          {
        ...
        internalType: "struct ChampagneSwapLottery.Lottery",
        name: "",
        type: "tuple",
      },
    ],
...
export class LotteryV2__factory {
  ...
  static createInterface(): LotteryV2Interface {
    return new utils.Interface(_abi) as LotteryV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LotteryV2 {
    return new Contract(address, _abi, signerOrProvider) as LotteryV2;
  }
}
