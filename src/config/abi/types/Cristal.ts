...
export interface CristalInterface extends utils.Interface {
  functions: {
    ...
    "safeChamTransfer(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "safeChamTransfer",
    values: [string, BigNumberish]
  ): string;
...
export interface Cristal extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CristalInterface;
