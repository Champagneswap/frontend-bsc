...
export interface ChamVaultInterface extends utils.Interface {
  functions: {
    ...
    "calculateHarvestChamRewards()": FunctionFragment;
    "calculateTotalPendingChamRewards()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "calculateHarvestChamRewards",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "calculateTotalPendingChamRewards",
    values?: undefined
  ): string;
...
export interface ChamVault extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChamVaultInterface;
  ...
  calculateHarvestChamRewards(overrides?: CallOverrides): Promise<BigNumber>;
