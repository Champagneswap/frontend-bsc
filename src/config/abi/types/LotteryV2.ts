...
export type LotteryStruct = {
  ...
  priceTicketInCham: BigNumberish;
  ...
  amountCollectedInCham: BigNumberish;
...
export interface LotteryV2Interface extends utils.Interface {
  functions: {
    ...
    "maxPriceTicketInCham()": FunctionFragment;
    "minPriceTicketInCham()": FunctionFragment;
    ...
    "setMinAndMaxTicketPriceInCham(uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "maxPriceTicketInCham",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "minPriceTicketInCham",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setMinAndMaxTicketPriceInCham",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface LotteryV2 extends BaseContract {
  ...
  functions: {
    ...
    maxPriceTicketInCham(overrides?: CallOverrides): Promise<[BigNumber]>;

    minPriceTicketInCham(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    setMinAndMaxTicketPriceInCham(
      _minPriceTicketInCham: BigNumberish,
      _maxPriceTicketInCham: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
    ...
    startLottery(
      ...
      _priceTicketInCham: BigNumberish,
      _discountDivisor: BigNumberish,
  ...
  populateTransaction: {
    ...
    maxPriceTicketInCham(
      overrides?: CallOverrides
    ): Promise<PopulatedTransaction>;

    minPriceTicketInCham(
      overrides?: CallOverrides
    ): Promise<PopulatedTransaction>;
