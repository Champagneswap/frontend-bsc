...
export interface TradingCompetitionInterface extends utils.Interface {
  functions: {
    ...
    "updateTeamRewards(uint256,uint256[5],uint256[5],uint256[5])": FunctionFragment;
  ...
  events: {
    "NewCompetitionStatus(uint8)": EventFragment;
    "OwnershipTransferred(address,address)": EventFragment;
    "TeamRewardsUpdate(uint256)": EventFragment;
    "UserRegister(address,uint256)": EventFragment;
    "UserUpdateMultiple(address[],uint256)": EventFragment;
    "WinningTeam(uint256)": EventFragment;
  };
...
export type UserUpdateMultipleEvent = TypedEvent<
  [string[], BigNumber],
  { userAddresses: string[]; rewardGroup: BigNumber }
>;

export type UserUpdateMultipleEventFilter =
  TypedEventFilter<UserUpdateMultipleEvent>;

export type WinningTeamEvent = TypedEvent<[BigNumber], { teamId: BigNumber }>;

export type WinningTeamEventFilter = TypedEventFilter<WinningTeamEvent>;

export interface TradingCompetition extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TradingCompetitionInterface;
  ...
  functions: {
    ...
    ): Promise<[boolean, boolean, BigNumber, BigNumber, BigNumber, boolean]>;
  ...
  filters: {
    "NewCompetitionStatus(uint8)"(
      status?: null
    ): NewCompetitionStatusEventFilter;
    NewCompetitionStatus(status?: null): NewCompetitionStatusEventFilter;
    ...
    "TeamRewardsUpdate(uint256)"(teamId?: null): TeamRewardsUpdateEventFilter;
    TeamRewardsUpdate(teamId?: null): TeamRewardsUpdateEventFilter;

    "UserRegister(address,uint256)"(
      userAddress?: null,
      teamId?: null
    ): UserRegisterEventFilter;
    UserRegister(userAddress?: null, teamId?: null): UserRegisterEventFilter;

    "UserUpdateMultiple(address[],uint256)"(
      userAddresses?: null,
      rewardGroup?: null
    ...
    "WinningTeam(uint256)"(teamId?: null): WinningTeamEventFilter;
    WinningTeam(teamId?: null): WinningTeamEventFilter;
  };
