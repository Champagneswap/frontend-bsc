...
export const getCampagneRollAddress = () => {
  return getAddress(addresses.champagneroll)
}
...
export const getChamVaultAddress = () => {
  return getAddress(addresses.chamVault)
}
...
export const getBunnySpecialChamVaultAddress = () => {
  return getAddress(addresses.bunnySpecialChamVault)
}
