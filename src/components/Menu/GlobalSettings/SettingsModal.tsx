...
import { Text, ChampagneToggle, Toggle, Flex, Modal, InjectedModalProps, ThemeSwitcher } from '@champagneswap/uikit'
import {
  useAudioModeManager,
    ...
    >
      <ScrollableContainer>
        ...
        <Flex justifyContent="space-between" alignItems="center">
          ...
          <ChampagneToggle checked={audioPlay} onChange={toggleSetAudioMode} scale="md" />
        </Flex>
      </ScrollableContainer>
    </Modal>
  )
