...
export function toV2LiquidityToken([tokenA, tokenB]: [Token, Token]): Token {
  return new Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'Cham-LP', 'Pancake LPs')
}
export function toV2LiquidityToken_Mig([tokenA, tokenB]: [Token, Token]): Token {
...
export function useTrackedTokenPairs_Mig(): [Token, Token][] {
  const { chainId } = useActiveWeb3React()
