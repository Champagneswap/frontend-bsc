...
export interface ChamVault {
  totalShares?: string
  pricePerFullShare?: string
  totalChamInVault?: string
  estimatedChamBountyReward?: string
  totalPendingChamHarvest?: string
  fees?: VaultFees
  userData?: VaultUser
}

export interface IfoChamVault extends Omit<ChamVault, 'userData'> {
...
export interface LotteryRound extends LotteryRoundGenerics {
  ...
  priceTicketInCham: BigNumber
  discountDivisor: BigNumber
  amountCollectedInCham: BigNumber
  chamPerBracket: string[]
  countWinnersPerBracket: string[]
  rewardsBreakdown: string[]
}

export interface LotteryResponse extends LotteryRoundGenerics {
  priceTicketInCham: SerializedBigNumber
  discountDivisor: SerializedBigNumber
  amountCollectedInCham: SerializedBigNumber
  chamPerBracket: SerializedBigNumber[]
