...
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, ChampagneDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | ChampagneDayData): ChartEntry => ({
