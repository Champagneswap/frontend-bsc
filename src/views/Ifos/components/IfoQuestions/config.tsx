...
const config = [
  {
    ...
    description: [
      <Trans>
        In the Basic Sale, every user can commit a maximum of about 100 USD worth of CHAM. We calculate the maximum CHAM
        amount about 30 minutes before each IFO. The Basic Sale has no participation fee.
      </Trans>,
      <Trans>
        In the Unlimited Sale, there’s no limit to the amount of CHAM you can commit. However, there’s a fee for
  ...
  },
  {
    ...
    description: [
      <Trans>
        ...
        Sale first. Just remember you need a ChampagneSwap Profile in order to participate.
      </Trans>,
    ],
  },
  {
  ...
  },
  {
    ...
    description: [<Trans>The CHAM from the participation fee will be thrown into the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of CHAM to either sale.</Trans>,
      <Trans>
