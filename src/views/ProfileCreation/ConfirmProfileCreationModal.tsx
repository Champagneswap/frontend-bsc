...
import { Modal, Flex, Text } from '@champagneswap/uikit'
import { BigNumber } from '@ethersproject/bignumber'
import { formatUnits } from '@ethersproject/units'
import { useAppDispatch } from 'state'
import { useTranslation } from 'contexts/Localization'
import { useCham, useProfileContract } from 'hooks/useContract'
  ...
  return (
    <Modal title={t('Complete Profile')} onDismiss={onDismiss}>
      ...
      <Flex justifyContent="space-between" mb="16px">
        <Text>{t('Cost')}</Text>
        <Text>{t('%num% CHAM', { num: formatUnits(REGISTER_COST) })}</Text>
      </Flex>
