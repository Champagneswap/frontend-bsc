...
import { Flex, Grid, Text, Button, Link, BinanceIcon, LinkExternal, useModal } from '@champagneswap/uikit'
import { useTranslation } from 'contexts/Localization'
import { nftsBaseUrl, champagneBunniesAddress } from 'views/Nft/market/constants'
...
const SellStage: React.FC<SellStageProps> = ({
  ...
  const itemPageUrlId =
    nftToSell.collectionAddress.toLowerCase() === champagneBunniesAddress.toLowerCase()
