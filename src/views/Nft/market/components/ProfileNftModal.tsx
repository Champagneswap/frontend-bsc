...
import { InjectedModalProps, Modal, Flex, Text, Button, useModal, Link, Grid, LinkExternal } from '@champagneswap/uikit'
...
import { nftsBaseUrl, champagneBunniesAddress } from '../constants'
...
const ProfileNftModal: React.FC<ProfileNftModalProps> = ({ nft, onDismiss, onSuccess }) => {
  ...
  const itemPageUrlId = nft.collectionAddress === champagneBunniesAddress ? nft.attributes[0].value : nft.tokenId
