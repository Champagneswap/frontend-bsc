...
import { Box, Button, Heading, Flex, LinkExternal } from '@champagneswap/uikit'
  ...
  return (
    <>
      ...
      <Gradient p="64px 0">
        ...
        <LinkExternal href="https://docs.champagneswap.com/contact-us/nft-market-applications" mx="auto" mt="16px">
