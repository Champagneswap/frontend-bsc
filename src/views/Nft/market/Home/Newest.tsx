...
import { Heading, Flex, Button, Grid, ChevronRightIcon } from '@champagneswap/uikit'
  ...
  return (
    <div>
      ...
      {nfts ? (
        ...
        >
          {nfts.map((nft) => {
            const isPBCollection = nft.collectionAddress.toLowerCase() === champagneBunniesAddress.toLowerCase()
