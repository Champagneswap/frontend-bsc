...
import { InjectedModalProps, Modal } from '@champagneswap/uikit'
...
import ApproveChamView from './ApproveChamView'
  ...
  return (
    <Modal title={viewTitle(t, currentView)} onBack={handleBack} onDismiss={onDismiss} hideCloseButton={!isStartView}>
      <div style={{ maxWidth: '400px' }}>
        ...
        {currentView === Views.APPROVE && <ApproveChamView goToChange={goToChange} onDismiss={onDismiss} />}
      </div>
    </Modal>
  )
}
