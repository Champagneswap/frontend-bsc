...
import { ArrowBackIcon, ArrowForwardIcon, Box, IconButton, Text, Flex, useMatchBreakpoints } from '@champagneswap/uikit'
...
const MoreFromThisCollection: React.FC<MoreFromThisCollectionProps> = ({
  ...
  const isPBCollection = isAddress(collectionAddress) === champagneBunniesAddress
