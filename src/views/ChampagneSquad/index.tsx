...
import ChampagneSquadHeader from './components/Header'
import { ChampagneSquadContext } from './context'
...
const ChampagneSquad: React.FC = () => {
  ...
  return (
    <ChampagneSquadContext.Provider value={{ isUserEnabled, setIsUserEnabled }}>
      <StyledSquadContainer>
        <ChampagneSquadHeader
          account={account}
          isLoading={isLoading}
          userInfos={userInfos}
    ...
    </ChampagneSquadContext.Provider>
  )
}
