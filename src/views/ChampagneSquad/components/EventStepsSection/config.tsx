...
import { Button } from '@champagneswap/uikit'
import { SaleStatusEnum, UserStatusEnum } from 'views/ChampagneSquad/types'
...
const stepsConfigBuilder = ({ t, userInfos, eventInfos, userStatus, account, theme, chamBalance }: EventStepsType) => {
  ...
  return [
    ...
    },
    {
      ...
      title: t('Hold CHAM'),
      bodyText: [t('Each NFT costs CHAM to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
