...
import { Box, Button, Card, CardBody, Flex, Step, Stepper, Text } from '@champagneswap/uikit'
import { useTranslation } from 'contexts/Localization'
import { StyledWaveContainer, LandingBodyWrapper } from 'views/ChampagneSquad/styles'
...
const EventStepsSection: React.FC<EventStepsProps> = ({ eventInfos, userInfos, isLoading, userStatus, account }) => {
  ...
  const stepsConfig = stepsConfigBuilder({ t, eventInfos, userInfos, userStatus, account, theme, chamBalance })
