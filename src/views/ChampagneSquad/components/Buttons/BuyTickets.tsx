...
import { Button, useModal } from '@champagneswap/uikit'
...
import { useCham, useNftSaleContract } from 'hooks/useContract'
import useToast from 'hooks/useToast'
import { DefaultTheme } from 'styled-components'
import { ethersToBigNumber } from 'utils/bigNumber'
import { ChampagneSquadContext } from 'views/ChampagneSquad/context'
...
const BuyTicketsButtons: React.FC<BuyTicketsProps> = ({
  ...
  const [onPresentEnableModal, onDismissEnableModal] = useModal(
    <ConfirmModal
      ...
      loadingText={t('Please enable CHAM spending in your wallet')}
