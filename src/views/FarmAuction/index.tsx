...
import { Button, Heading, Text, Flex, Link, Breadcrumbs } from '@champagneswap/uikit'
...
import AuctionChamBurn from './components/AuctionChamBurn'
...
const CHAM_BURN_BG_LIGHT = 'radial-gradient(50% 79.31% at 50% 50%, #FAF9FA 0%, #EAECF4 100%)'
const CHAM_BURN_TOP_FILL_LIGHT = 'radial-gradient(ellipse at bottom, #f0f1f6, #EAECF4)'
const CHAM_BURN_BG_DARK = 'radial-gradient(103.12% 50% at 50% 50%, #152534 0%, #191326 100%)'
const CHAM_BURN_TOP_FILL_DARK = '#191326'
  ...
  return (
    <>
        ...
        <Flex flexDirection={['column-reverse', null, 'row']}>
          <Left>
            ...
            <Text color="textSubtle" mb="24px">
              {t('Each week, qualifying projects can bid CHAM for the right to host a 7-day Farm on ChampagneSwap.')}
            </Text>
      ...
      <>
        ...
        <PageSection
          background={theme.isDark ? CHAM_BURN_BG_DARK : CHAM_BURN_BG_LIGHT}
          index={2}
          innerProps={{ style: { width: '100%' } }}
          dividerPosition="top"
          dividerFill={{ light: CHAM_BURN_TOP_FILL_LIGHT, dark: CHAM_BURN_TOP_FILL_DARK }}
        >
          <AuctionChamBurn />
        </PageSection>
        <PageSection
          ...
          dividerFill={{ light: CHAM_BURN_BG_LIGHT, dark: CHAM_BURN_BG_DARK }}
          concaveDivider
          index={3}
          dividerPosition="top"
        >
