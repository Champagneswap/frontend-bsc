...
import { Flex, Text, Box, Skeleton } from '@champagneswap/uikit'
...
export const IfoVaultCardAvgBalance = () => {
  ...
  const creditsDollarValue: number | undefined = useBUSDChamAmount(chamAsNumberBalance)
        ...
        <QuestionHelper
          ...
          text={
            <>
              <Text>
                {t(
                  'Your entry limit in the next IFO sale is determined by your IFO credit. This is calculated by the average CHAM balance of the principal amount in the IFO pool during the last credit calculation period.',
                )}
              </Text>
              <Text>
                {t(
...
const ChamVaultCardActions: React.FC<{
...
export default ChamVaultCardActions
