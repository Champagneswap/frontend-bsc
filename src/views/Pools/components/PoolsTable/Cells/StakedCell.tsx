import { Box, Flex, Skeleton, Text, useMatchBreakpoints } from '@champagneswap/uikit'
            ...
            <Flex>
              <Box mr="8px" height="32px">
                <Balance
                  ...
                  value={
                    pool.vaultKey ? (Number.isNaN(chamAsNumberBalance) ? 0 : chamAsNumberBalance) : stakedTokenBalance
                  }
                />
                {hasStaked ? (
                  <Balance
