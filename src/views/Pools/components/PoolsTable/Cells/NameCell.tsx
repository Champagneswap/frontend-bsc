...
import { Text, useMatchBreakpoints, TokenPairImage as UITokenPairImage } from '@champagneswap/uikit'
...
const NameCell: React.FC<NameCellProps> = ({ pool }) => {
  ...
  } else if (isManualChamPool) {
    title = t('Manual CHAM')
    subtitle = `${t('Earn')} CHAM ${t('Stake').toLocaleLowerCase()} CHAM`
  }
