import { Box, Flex, HelpIcon, Skeleton, Text, useMatchBreakpoints, useTooltip } from '@champagneswap/uikit'
...
const IFOCreditCell: React.FC<IFOCreditCellProps> = ({ account }) => {
  ...
  const avgBalanceDollarValue = useBUSDChamAmount(chamAsNumberBalance)
            ...
            <Flex>
              <Box mr="8px" height="32px">
                <Balance
                  ...
                  value={hasCredit ? chamAsNumberBalance : 0}
                />
                {hasCredit ? (
                  <Balance
                    display="inline"
