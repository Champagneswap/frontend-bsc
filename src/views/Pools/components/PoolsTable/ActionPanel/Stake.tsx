import { AddIcon, Button, Flex, IconButton, MinusIcon, Skeleton, Text, useModal, useTooltip } from '@champagneswap/uikit'
...
import VaultStakeModal from '../../ChamVaultCard/VaultStakeModal'
...
const Staked: React.FunctionComponent<StackedActionProps> = ({ pool, userDataLoaded }) => {
  ...
  const stakedAutoDollarValue = getBalanceNumber(chamAsBigNumber.multipliedBy(stakingTokenPrice), stakingToken.decimals)
  ...
  const [onPresentVaultUnstake] = useModal(<VaultStakeModal stakingMax={chamAsBigNumber} pool={pool} isRemovingStake />)
        ...
        <ActionContent>
          <Flex flex="1" pt="16px" flexDirection="column" alignSelf="flex-start">
            <Balance
              ...
              fontSize="20px"
              decimals={5}
              value={vaultKey ? chamAsNumberBalance : stakedTokenBalance}
            />
            <Balance
              fontSize="12px"
              display="inline"
