...
import { Text, Flex, TooltipText, useTooltip, Skeleton, Heading } from '@champagneswap/uikit'
...
import UnstakingFeeCountdownRow from '../../ChamVaultCard/UnstakingFeeCountdownRow'
...
const AutoHarvestAction: React.FunctionComponent<AutoHarvestActionProps> = ({
  ...
  const {
    userData: { chamAtLastUserAction, userShares },
    pricePerFullShare,
    fees: { performanceFee },
