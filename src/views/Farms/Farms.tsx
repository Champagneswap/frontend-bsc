...
import { Image, Heading, RowType, Toggle, Text, Button, ArrowForwardIcon, Flex } from '@champagneswap/uikit'
import { ChainId } from '@champagneswap/sdk'
import { NextLinkFromReactRouter } from 'components/NextLink'
import styled from 'styled-components'
import FlexLayout from 'components/Layout/Flex'
import Page from 'components/Layout/Page'
import { useFarms, usePollFarmsWithUserData, usePriceChamBusd } from 'state/farms/hooks'
...
export const getDisplayApr = (chamRewardsApr?: number, lpRewardsApr?: number) => {
  if (chamRewardsApr && lpRewardsApr) {
    return (chamRewardsApr + lpRewardsApr).toLocaleString('en-US', { maximumFractionDigits: 2 })
  }
  if (chamRewardsApr) {
    return chamRewardsApr.toLocaleString('en-US', { maximumFractionDigits: 2 })
  }
  return null
}
...
const Farms: React.FC = ({ children }) => {
  ...
  const rowData = chosenFarmsMemoized.map((farm) => {
    ...
    const lpLabel = farm.lpSymbol && farm.lpSymbol.split(' ')[0].toUpperCase().replace('CHAMPAGNE', '')
  ...
  return (
    <FarmsContext.Provider value={{ chosenFarmsMemoized }}>
      ...
      <Page>
        ...
        <div ref={observerRef} />
        <StyledImage src="/images/decorations/3dpan.png" alt="CHAMPAGNE illustration" width={120} height={103} />
      </Page>
