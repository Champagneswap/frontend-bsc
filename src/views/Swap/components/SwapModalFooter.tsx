...
import { Trade, TradeType } from '@champagneswap/sdk'
import { Button, Text, AutoRenewIcon } from '@champagneswap/uikit'
            ...
            <QuestionHelper
              text={
                <>
                  ...
                  <Text>- {t('%amount% towards CHAM buyback and burn', { amount: '0.05%' })}</Text>
                </>
              }
              ml="4px"
            />
