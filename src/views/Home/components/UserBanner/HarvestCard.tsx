...
import { AutoRenewIcon, Button, Card, CardBody, Flex, Skeleton, Text, ArrowForwardIcon } from '@champagneswap/uikit'
...
const HarvestCard = () => {
  ...
  const earningsBusd = new BigNumber(farmEarningsSum).multipliedBy(chamPriceBusd)
  ...
  const hasChamPoolToCollect = numTotalToCollect - numFarmsToCollect > 0

  const earningsText = getEarningsText(numFarmsToCollect, hasChamPoolToCollect, earningsBusd, t)
      ...
      if (receipt?.status) {
        toastSuccess(
          ...
          <ToastDescriptionWithTx txHash={receipt.transactionHash}>
            {t('Your %symbol% earnings have been sent to your wallet!', { symbol: 'CHAM' })}
