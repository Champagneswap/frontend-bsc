...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@champagneswap/uikit'
...
const LotteryCardContent = () => {
  ...
  useSlowRefreshEffect(() => {
    ...
    const fetchCurrentLotteryPrize = async () => {
      const { amountCollectedInCham } = await fetchLottery(lotteryId)
      const prizeInBusd = chamPriceBusd.times(amountCollectedInCham)
  ...
  }, [lotteryId, setCurrentLotteryPrize, chamPriceBusd])
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with CHAM, win CHAM if your numbers match')}
        </Text>
      </Flex>
