...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@champagneswap/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'CHAM card' },
    { src: 'green', alt: 'Green CHAM card with up arrow' },
    { src: 'red', alt: 'Red Cham card with down arrow' },
    { src: 'top-right', alt: 'CHAM card' },
  ],
}
